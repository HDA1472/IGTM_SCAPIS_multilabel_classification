...
res <- lapply(disease_vec, function(disease) {
  ...
  model_res <- rf(discovery_cohort, disease, cv_sets = 10, cor_threshold = 0.9, grid_size = 60)
  boxplot <- plot_protein_boxplot(data_igt, disease, model_res$features, points = FALSE)
  return(c(model_res, list("boxplot" = boxplot)))
})
...
res <- lapply(disease_vec, function(disease) {
  ...
  model_res <- lasso(data_igt, disease, cv_sets = 10, cor_threshold = 0.9, grid_size = 30)
  boxplot <- plot_protein_boxplot(data_igt, disease, model_res$features, points = FALSE)
  return(c(model_res, list("boxplot" = boxplot)))
})
...
ggraph(graph, layout = "fr") +
  geom_edge_link(aes(width = SharedFeatures, color = EdgeColor), show.legend = FALSE) +
  ...
  labs(title = "Feature Sharing Among Models",
