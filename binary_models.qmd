...
```{r}
saveRDS(res, file="results/models_cac100/lasso_binary.RData")
```
...
saveRDS(features, file="results/models_results_cac100/lasso_features.RData")
saveRDS(auc, file="results/models_results_cac100/lasso_auc.RData")
```

### Validate on SCAPIS

```{r}
lasso_binary <- readRDS("results/models_cac100/lasso_binary.RData")
```
...
saveRDS(auc_all, file="results/models_results_cac100/lasso_validate_auc.RData")
```
