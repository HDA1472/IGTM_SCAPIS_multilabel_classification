...
```{r}
disease_cols <- c("Obesity", "MS", "MASLD", "CAC", "Carotid_plaque", "Atrial_fibrillation", "Stroke", "COPD", "Asthma", "Tuberculosis", "Sleep_apnea", "Celiac_disease", "Crohn", "Rheumatic_disease", "T2D", "IGT")  # "Myocardial_infarction", "Coronary_artery_intervention", 
