...
```{r}
na_count_scapis <- colSums(is.na(data_scapis_joined))
print("SCAPIS")
na_count_scapis[na_count_scapis > 0]

print("IGT")
na_count_igt <- colSums(is.na(data_igt_joined))
na_count_igt[na_count_igt > 0]
```

Remove rows containing NA values in diseases of interest, Sex and Age. We lost 75 patients from SCAPIS cohort and 34 from IGT.
