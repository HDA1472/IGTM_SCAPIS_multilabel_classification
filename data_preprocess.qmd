...
```{r}
metadata_cols <- c("DAid", "Sex", "Age", "Smoke_status", "SBP_Mean", "DBP_Mean", "HbA1c", "Chol", "LDL", "HDL", "TG", "ALT", "GGT", "Urate", "Crea", "eGFR", "CRP", "Hb", "WBC", "PLT", "Hten_med", "Lipid_med", "Obesity", "IGT", "MS", "MASLD", "carotidplaque", "CAC", "Sleep_apnea")
...
```{r}
all_metadata_cols <- c("Obesity", "MS", "MASLD", "CAC", "carotidplaque", "Sleep_apnea", "IGT", "Weight", "BMI", "Waist", "SBP_Mean", "DBP_Mean", "Glucose", "HbA1c", "HOMA_IR", "Chol", "LDL", "HDL", "TG", "ALT", "GGT", "Urate", "Crea", "eGFR", "CRP", "Hb", "WBC", "PLT", "Sex", "Age")
